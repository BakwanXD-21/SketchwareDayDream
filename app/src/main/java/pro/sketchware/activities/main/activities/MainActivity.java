...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding.statusBarOverlapper.setMinimumHeight(
                UI.getStatusBarHeight(this)
        );

        UI.addSystemWindowInsetToPadding(
                binding.appbar,
                true,
                false,
                true,
        ...
        if (System.currentTimeMillis() - u1I1
                > 1000 * 60 * 60 * 24) {

            u.a(
                    "U1I0",
                    Integer.valueOf(u1I0 + 1)
            );
        }
        ...
        /*
         * Jangan gunakan icon bawaan
         * ActionBarDrawerToggle.
         */
        drawerToggle.setDrawerIndicatorEnabled(false);

        /*
         * Pastikan Toolbar benar-benar
         * tidak memiliki icon navigation.
         */
         ...
         * =========================
         *
         * Tombol drawer sekarang berasal
         * langsung dari XML:
         *
         * @id/drawerToggleBtn
         */
        ...
        binding.drawerLayout.setDrawerElevation(
                0f
        );
        ...
        GradientDrawable searchCircle =
                new GradientDrawable();

        searchCircle.setShape(
                GradientDrawable.OVAL
        );

        searchCircle.setColor(
        ...
        binding.searchButton.setBackground(
                searchCircle
        );
        ...
        if (Intent.ACTION_VIEW.equals(
            ...
            if (data != null) {
                ...
                new SingleCopyTask(
                    ...
                    @Override
                    public void onCopyProgressUpdate(
                            int progress) {
                    }


                    @Override
                    public void onCopyPostExecute(
                            @NonNull String path,
                        ...
                        if (wasSuccessful) {
                            ...
                            if (BackupFactory.zipContainsFile(
                                    path,
                                    "local_libs")) {
                            ...
                            SketchwareUtil.toastError(
                                    "Failed to copy backup file to temporary location: "
                                            + reason,
                                    Toast.LENGTH_LONG
                            );
                        }
        ...
        if (binding.searchInput.hasFocus()) {
            ...
            if (imm != null) {
                ...
                imm.hideSoftInputFromWindow(
                        binding.searchInput.getWindowToken(),
                        0
                );
            }
        }
        ...
        binding.searchInput.addTextChangedListener(
            ...
            public void onTextChanged(
                ...
                if (projectsFragment != null) {
                    ...
                    projectsFragment.filterProjects(
                            s == null
                                    ? ""
                                    : s.toString()
                    );
    ...
    private void openFabMenu() {
        ...
        binding.layoutFabCreate
                .setVisibility(View.VISIBLE);

        binding.layoutFabRestore
                .setVisibility(View.VISIBLE);
    ...
    private Fragment getFragmentForNavId(
            int navItemId) {
    ...
    public void onPostCreate(
        ...
        /*
         * Jangan biarkan Toolbar menampilkan
         * navigation/back icon.
         */
        binding.toolbar.setNavigationIcon(null);
    }
    ...
    private void showNoticeNeedStorageAccess() {
        ...
        dialog.setTitle(
                Helper.getResString(
                        R.string.common_message_permission_title_storage
                )
        );
        ...
        dialog.setMessage(
                Helper.getResString(
                        R.string.common_message_permission_need_load_project
                )
        );
    ...
    private void showNoticeNotEnoughFreeStorageSpace() {
        ...
        dialog.setTitle(
                Helper.getResString(
                        R.string
                                .common_message_insufficient_storage_space_title
                )
        );


        dialog.setIcon(
                R.drawable.disc_full_24px
        );
        ...
        dialog.setMessage(
                Helper.getResString(
                        R.string
                                .common_message_insufficient_storage_space
                )
        );
        ...
        if (storageAccessDenied == null
            ...
            storageAccessDenied =
                    Snackbar.make(
                            ...
                            Helper.getResString(
                                    R.string
                                            .common_message_permission_denied
                            ),
            ...
            storageAccessDenied.setActionTextColor(
                    Color.YELLOW
            );
