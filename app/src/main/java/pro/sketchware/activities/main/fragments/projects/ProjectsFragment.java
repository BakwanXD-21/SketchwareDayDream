...
public class ProjectsFragment extends DA {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // FAB sekarang dikontrol dari MainActivity, tidak di sini
        ...
        // Restore dari special action card di fragment tetap berfungsi
        binding.specialAction.projectOne.setOnClickListener(v -> restoreProject());

        if (LibraryUtils.isAllowUseGit()) {
            binding.specialAction.projectRestoregit.setOnClickListener(v ->
                    startActivity(new Intent(requireContext(), GitCloneActivity.class)));
        } else {
    ...
    /**
     * Dipanggil dari MainActivity saat SearchView di toolbar berubah.
     */
